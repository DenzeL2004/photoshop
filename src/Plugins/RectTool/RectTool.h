...
class RectToolPreview;

class RectTool : public DefTool
{
    public:
        RectTool();
        ...
        RectTool(const RectTool &other) = delete;
        RectTool &operator= (const RectTool &other) = delete;
